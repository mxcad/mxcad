...
▸ **convertToImage**(`canvas`, `width`, `height`, `type`): `undefined` \| [`HTMLImageElement`]( https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement )
...
`undefined` \| [`HTMLImageElement`]( https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement )
