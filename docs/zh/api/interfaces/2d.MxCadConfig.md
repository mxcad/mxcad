...
- [wasmx64](2d.MxCadConfig.md#wasmx64)
...
• `Optional` **canvas**: `string` \| [`HTMLCanvasElement`]( https://developer.mozilla.org/docs/Web/API/HTMLCanvasElement )
...
| `base?` | `string` \| [`URL`]( https://developer.mozilla.org/docs/Web/API/URL ) | 相对于js调用位置的http URL绝对路径 |
...
• `Optional` **onInit**: [`Function`]( https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function )
...
• `Optional` **onOpenFileComplete**: [`Function`]( https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function )
...
• `Optional` **wasmBinary**: [`ArrayBuffer`]( https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer )
