...
点击 [McObject.on()](../../api/classes/2d.McObject.md#on)、[McObject.mxdraw.on()](https://help.mxdraw.com/mxdraw_docs/api/classes/MxDrawObject.html#on)、[McObject.off()](../../api/classes/2d.McObject.md#off)、[McObject.mxdraw.off()](https://help.mxdraw.com/mxdraw_docs/api/classes/MxDrawObject.html#off) 查看更多详细属性和方法说明。
