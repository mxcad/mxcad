...
**(2) Direct Command Line Invocation**

After the deployment is completed, enter the `MxDrawCloudServer\Bin\Release\tool` directory in the command line terminal and execute the following command:

```bash
MxWebDwg2Jpg.exe cadtojpg "file=D:/Test/2.dwg" "width=1000" "height=1000"
```

**(3) Interface Invocation Method**
