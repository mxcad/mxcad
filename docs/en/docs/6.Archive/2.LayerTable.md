...
2. Get or set whether the layer is off: the off layer entity does not participate in the generation of display data, which can speed up the display, and the speed of opening the drawing.
...
3. Get or set whether the layer is frozen: The layer entity on which the layer is frozen cannot participate in editing operations.
