...
▸ **addImageDefine**(`imageUrl`, `sName?`, `isConvertBase64?`, `sourceFileName?`): [`McObjectId`](2d.McObjectId.md)
...
▸ **drawImage**(`dPosX`, `dPosY`, `dWidth`, `dHeight`, `dAng`, `imageName`, `isConvertBase64?`, `dwgImageSizeWidth?`, `dwgImageSizeHeight?`, `imageUrl?`): [`McObjectId`](2d.McObjectId.md)
...
Obtain temporary drawing module
...
When redrawing objects in the block table record and modifying the objects in the block table record to achieve the desired display effect, it may be necessary to call this function.

#### Parameters

| Name | Type |
| :------ | :------ |
| `idBlockRecord` | [`McObjectId`](2d.McObjectId.md) |
...
| Name | Type | Description |
| :------ | :------ | :------ |
|SSaveProgramURL | string | Backend POST request interface, specific implementation of the interface: First download the MxDraw cloud map development package< https://www.mxdraw.com/download.html >And unzip and find MxDrawCloudServer \ Bin \ MXCAD \ MXCADSaveFile \ serverless. js to find the corresponding implementation interface "/mxcad/sawdwg", "/mxcad/sawdwg": save DWG file to server "/mxcad/sawfile": save MXweb file to server "/mxcad/sawpdf": save PDF file to server. If not found, search for the definition of this interface under this project, which must comply with the definition of this interface to be used as a parameter|
...
| Name | Type | Description |
| :------ | :------ | :------ |
|Val | object | Property setting content one Display Precision: Number display precision setting, default is 0, can take 0~10001000 as the highest precision Enable undo: boolean Enable undo function, default is not started 3 ShowCoordinate: boolean Whether to display XY axis 4 BlackWhiteDisplay: boolean Whether to display in black and white|
